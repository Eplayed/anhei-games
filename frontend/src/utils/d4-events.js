 ...
 * 校准日期: 2026-05-13 (验证世界Boss/军团/地狱狂潮时间与helltides.com一致)
...
/**
 * Boss 名称映射 (n % 15)
 * 注意: S13起新增第4个世界Boss Azmodan，轮换机制可能已调整
 * 0,1,2,8,9 → "疫王"阿煞巴 (Ashava)
 * 3,4,10,11,12 → 徘徊死魔 (Wandering Death)
 * 5,6,7,13,14 → "诅咒之金"贪魔 (Avarice)
 * Azmodan 目前未包含在此3boss循环中，待社区确认4boss轮换后更新
 */
const BOSS_MAP = {
  '疫王阿煞巴': [0, 1, 2, 8, 9],
  '徘徊死魔': [3, 4, 10, 11, 12],
